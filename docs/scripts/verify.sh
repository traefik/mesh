...
| xargs -0 -r -P "${NUMBER_OF_CPUS}" -I '{}' \
  ...
  --url_ignore="/https://groups.google.com/a/mae.sh/forum/#!forum/security/,/localhost:/,/127.0.0.1:/,/fonts.gstatic.com/,/.minikube/,/github.com\/containous\/maesh\/*edit*/,/github.com\/containous\/maesh\/$/,/docs.maesh.io/" \
  '{}' 1>/dev/null
