...
| xargs -0 -r -P "${NUMBER_OF_CPUS}" -I '{}' \
  ...
  --url_ignore="/fonts.gstatic.com/,/traefik-mesh/,/github.com\/traefik\/mesh\/edit*/,/pilot.traefik.io\/profile/,/traefik.io/,/doc.traefik.io/,/www.mkdocs.org/,/squidfunk.github.io/,/ietf.org/,/docs.github.com/,/github.com\/servicemeshinterface\/smi-spec/" \
  '{}' 1>/dev/null
