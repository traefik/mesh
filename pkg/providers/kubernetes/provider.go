...
func New(defaultMode string, tcpStateTable TCPPortMapper, ignored k8s.IgnoreWrapper, serviceLister listers.ServiceLister, endpointsLister listers.EndpointsLister, minHTTPPort, maxHTTPPort int32) *Provider {
	p := &Provider{
